...
export type TextPropsType = CommonPropsType &
  CommonTextProps &
  TextTypesUnionType
...
export type ColorTokensLighterOrDarkerType =
  | 'primary-lighter'
  | 'primary-darker'
  | 'secondary-lighter'
  | 'secondary-darker'
...
export type ColorTokensWithLighterAndDarkerType =
  | ColorTokensType
  | ColorTokensLighterOrDarkerType
